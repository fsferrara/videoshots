...
ControllerListener
{
   ...
   public void init() 
   {
      ...
      // Tempo inizio
      if(getParameter("inizio")!=null && !getParameter("inizio").equals("null") )
    	  inizio=Double.parseDouble(getParameter("inizio"));
      
	  // Tempo fine
	  if(getParameter("durata")!=null && !getParameter("durata").equals("null"))
		  fine=inizio + Double.parseDouble(getParameter("durata"));
   ...
   public synchronized void controllerUpdate(ControllerEvent event) 
   {
      ...
      {
    	// Imposta quando si deve fermare la riproduzione ma non taglia il video
      	if(fine!=null)
    	  player.setStopTime(new Time(fine));
         ...
         if ((controlComponent = player.getControlPanelComponent()) != null)
      	...
      	// Se il player e' nello stato Prefatched
      	//Setta quando deve iniziare il video ma non lo taglia.
      		if (inizio!=null){
      			player.setMediaTime(new Time(inizio));
            	player.start();
      		}
      ...
      else if (event instanceof EndOfMediaEvent) 
      {
         ...
         // start over
    	  //PUNTO IN CUI IL PLAYER RIPETE LA RIPRODUZIONE DEI VIDEO
